    ...
    <div className="w-full flex flex-col gap-1.5">
      ...
      <div className="relative">
        <select
          ...
          className={cn(
            'w-full appearance-none px-3.5 py-2.5 pr-10 text-sm font-medium bg-white text-zinc-900 border-2 border-zinc-900 rounded-2xl shadow-playful-sm focus:outline-none focus:ring-2 focus:ring-orange-400 transition-all duration-150 cursor-pointer',
